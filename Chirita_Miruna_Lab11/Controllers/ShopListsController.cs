...
namespace Chirita_Miruna_Lab11.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Chirita_Miruna_Lab11Context _context;

        public ShopListsController(Chirita_Miruna_Lab11Context context)
        {
            _context = context;
        }
